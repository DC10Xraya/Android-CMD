cmd_bomb_fork() {
    ...
    cecho "$CMD_delimiter"
    err "![引爆须知/非常重要]!"
    err "如果你真的想引爆这个炸弹,请进入该函数(resource/00#高危/cmd_bomb_fork.bash)的对应位置,将86行的注释(开头的#)移除"
    ...
    cecho "如果你真的想引爆这个炸弹,请进入该函数(resource/00#高危/cmd_bomb_fork.bash)的对应位置,将86行的注释(开头的#)移除"
    err "(如果你这么做了即代表你已经同意作者不承担任何设备损坏或数据丢失的责任!!!)"
    echo ""
    return 0
    # ---------- 恢复陷阱 ----------
