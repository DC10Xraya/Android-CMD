...
- 控制台增强: CLSD 控制 CLS 默认行为, CLS 支持 -n 参数隐藏标题 (CLSNT 已弃用)
- Laugh: 一些彩蛋, 不告诉你 awa
...
- Lazy加载(0.05+), 启动更快
- 下载解压一键式使用, 上手简单
- 模块化设计, 新的函数可以放在 resource 目录中, 易于维护 ; 配置与历史记录保存在 etc 目录下(0.06+)
- 命令众多, 功能强大, 现已超过 180 个开发版本
...
杂七杂八
---------
这个脚本虽然开发了很久(180多个dev), 但是难免会有不足, 遇到任何问题都可以向我提出, 不喜欢也别喷qwq
